...
struct EngConstructionScreen: View {
    var body: some View {
        ZStack{
            VStack{
                TopNavigation(titleText: "Engineering Construction")
                ScrollView{
                    VStack{
                        HStack
                        {
...
struct EngConstructionScreen_Previews: PreviewProvider {
    static var previews: some View {
        EngConstructionScreen()
    }
}
